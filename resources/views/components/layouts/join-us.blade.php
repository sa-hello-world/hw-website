        ...
        <div class="bg-white rounded-2xl p-8 relative">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="text-center">
                    <div class="bg-hwpink font-title text-white px-6 py-3 rounded-lg font-bold text-xl mb-6 inline-block">
                        NON MEMBER
                    </div>

                    <div class="space-y-4 text-left">
                        <div class="flex items-center space-x-3">
                            <div class="w-5 h-5 border-2 border-hwgreen rounded flex items-center justify-center">
                                <div class="w-2 h-2 bg-hwgreen rounded-full"></div>
                            </div>
                ...
                <div class="text-center">
                    ...
                    <div class="mt-8 space-y-4">
                        <div class="flex items-center justify-between bg-gray-100 p-3 rounded-lg">
                            <span class="text-hwblack font-handwriting">Early bird - 15€</span>
                            <button class="bg-white border-2 border-hwblack px-4 py-1 rounded text-sm font-semibold">
                                Order
                            </button>
                        </div>
                        <div class="flex items-center justify-between bg-gray-100 p-3 rounded-lg">
                            <span class="text-hwblack font-handwriting">Normal - 30€</span>
                            <button class="bg-white border-2 border-hwblack px-4 py-1 rounded text-sm font-semibold">
                                Order
                            </button>
                        </div>
