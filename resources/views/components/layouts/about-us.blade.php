    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="flex justify-center mb-8">
            <div class="flex space-x-2">
                @for($i = 0; $i < 20; $i++)
                    <div class="w-3 h-3 bg-hwblack rounded-full"></div>
                @endfor
            </div>
        </div>

        <div class="text-center">
            <h2 class="text-hwblack font-title text-3xl font-bold mb-6 uppercase">
                WHAT IS SA HELLO WORLD?
            </h2>

            <div class="text-left max-w-2xl mx-auto space-y-4 text-hwblack">
                <div>
            ...
            <p class="mt-4 text-blue-500 font-handwritten text-lg">
