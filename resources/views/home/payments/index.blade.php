...
<x-layouts.hub>
    <div class="py-5">
        <h1 class="text-3xl md:text-5xl font-bayon text-white">My Payments</h1>
        <p class="text-md md:text-xl text-hw-blue-400">A complete overview of all your transactions in one place.</p>
    </div>
