...
<x-layouts.hub>
    <div class="py-5">
        <h1 class="text-5xl font-bayon text-white">My Payments</h1>
        <p class="text-xl text-hw-blue-400">A complete overview of all your transactions in one place.</p>
    </div>
                        ...
                        <tr class="hover:bg-neutral-900 transition-all">
                            ...
                            <td class="px-4 py-4">
                              <div class="flex gap-x-3">
                                  <a href="{{route('my.payments.show', $payment)}}">
