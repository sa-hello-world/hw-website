            ...
            <div class="space-y-6">
                <div>
                    ...
                    <x-hw.input
                        ...
                        value="{{ old('regular_membership_price', MoneyHelper::toDecimal($schoolYear->regular_membership_price) ?? '') }}"
                        step="0.01"
                        min="0"
                        inputmode="decimal"
                        required
                ...
                <div>
                    ...
                    <x-hw.input
                        ...
                        value="{{ old('early_membership_price', MoneyHelper::toDecimal( $schoolYear->early_membership_price) ?? '') }}"
                        step="0.01"
                        min="0"
                        inputmode="decimal"
                    />
                ...
                <div>
                    ...
                    <x-hw.input
                        ...
                        value="{{ old('semester_membership_price', MoneyHelper::toDecimal($schoolYear->semester_membership_price) ?? '') }}"
                        step="0.01"
                        min="0"
                        inputmode="decimal"
                    />
